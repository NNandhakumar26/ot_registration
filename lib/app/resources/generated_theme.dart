...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      tertiaryContainer: Color(4294891257),
      ...
      onPrimaryFixedVariant: Color(4281419128),
      secondaryFixed: Color(4291749375),
      onSecondaryFixed: Color(4278197554),
      secondaryFixedDim: Color(4288400378),
      onSecondaryFixedVariant: Color(4279061107),
      tertiaryFixed: Color(4294891257),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      secondary: Color(4278470254),
      onSecondary: Color(4294967295),
      secondaryContainer: Color(4282874276),
      onSecondaryContainer: Color(4294967295),
      tertiary: Color(4283840853),
      onTertiary: Color(4294967295),
      ...
      primaryFixedDim: Color(4282866319),
      onPrimaryFixedVariant: Color(4294967295),
      secondaryFixed: Color(4282874276),
      onSecondaryFixed: Color(4294967295),
      secondaryFixedDim: Color(4281098377),
      onSecondaryFixedVariant: Color(4294967295),
      tertiaryFixed: Color(4287326856),
      onTertiaryFixed: Color(4294967295),
      tertiaryFixedDim: Color(4285616751),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      onSecondary: Color(4294967295),
      secondaryContainer: Color(4278470254),
      onSecondaryContainer: Color(4294967295),
      tertiary: Color(4281473330),
      onTertiary: Color(4294967295),
      tertiaryContainer: Color(4283840853),
      onTertiaryContainer: Color(4294967295),
      ...
      onPrimaryFixed: Color(4294967295),
      primaryFixedDim: Color(4279511644),
      onPrimaryFixedVariant: Color(4294967295),
      secondaryFixed: Color(4278470254),
      onSecondaryFixed: Color(4294967295),
      secondaryFixedDim: Color(4278202189),
      onSecondaryFixedVariant: Color(4294967295),
      tertiaryFixed: Color(4283840853),
      onTertiaryFixed: Color(4294967295),
  ...
  static MaterialScheme darkScheme() {
    return const MaterialScheme(
      ...
      secondary: Color(4288400378),
      onSecondary: Color(4278203219),
      secondaryContainer: Color(4279061107),
      ...
      onTertiaryContainer: Color(4294891257),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      primaryContainer: Color(4286353352),
      ...
      primaryFixedDim: Color(4289906175),
      onPrimaryFixedVariant: Color(4280235110),
      secondaryFixed: Color(4291749375),
  ...
  final fillColor = MaterialStateColor.resolveWith(
    (states) {
      if (states.contains(MaterialState.disabled)) {
        return Color(0xff000000).withOpacity(0.032);
      } else
  ...
  ThemeData theme(ColorScheme colorScheme) => ThemeData(
      ...
      scaffoldBackgroundColor: colorScheme.background.withOpacity(0.98),
      canvasColor: colorScheme.surface,
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: fillColor,
        errorMaxLines: 1,
        // This style is same as the bodytext2's / Body medium
        labelStyle: GoogleFonts.roboto(
          height: 1.4,
          color:
              AppColor.getColor(isDarkMode).surfaceOnSurface.withOpacity(0.54),
          fontSize: 14,
        ...
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
            color: AppColor.getColor(isDarkMode).outlineOutlineVariant,
            width: 1.0,
          ),
        ),

        hoverColor: AppColor.getColor(isDarkMode).scaffoldBackgroundColor,

        disabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(4.0),
          borderSide: BorderSide(
            color: AppColor.getColor(isDarkMode)
                .outlineOutlineVariant
                .withOpacity(0.38),
            width: 1.0,
          ),
        ),
...
abstract class AppColor {
  ...
  Color get surfaceSurface;
  Color get surfaceOnSurfaceVariant;

  Color get surfaceOnSurface;
  Color get scaffoldBackgroundColor;
  Color get outlineOutlineVariant;
  Color get backgroundOnBackground;
  Color get backgroundBackground;
  Color get surfaceContainerSurfaceContainerLow;
  Color get surfaceContainerSurfaceContainerLowest;
  Color get surfaceContainerSurfaceContainer;

  static AppColor getColor(bool isDarkMode) => LightThemeColors();
}

class LightThemeColors extends AppColor {
  @override
  Color get primary => Color(0xff01042D);
  @override
  Color get primaryColor => Color(0xff4C57A9);
  ...
  @override
  Color get surfaceOnSurfaceVariant => Color(0xff414458);

  @override
  Color get surfaceOnSurface => Color(0xff17171C);

  @override
  Color get scaffoldBackgroundColor => Color(0xffF4F4F6);

  @override
  Color get outlineOutlineVariant => Color(0xffC4C6D4);

  @override
  Color get surfaceSurface => Color(0xffF9F9FA);

  @override
  Color get backgroundBackground => Color(0xff17171C);

  @override
  Color get backgroundOnBackground => Color(0xffE3E3E8);

  @override
  Color get surfaceContainerSurfaceContainerLow => Color(0xffEEEEF1);

  @override
  Color get surfaceContainerSurfaceContainer => Color(0xffEEEEF1);

  @override
  Color get surfaceContainerSurfaceContainerLowest => Color(0xffFFFFFF);
}
